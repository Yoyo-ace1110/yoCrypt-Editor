...
- **[Feature Guide](./encryption_features)**: Details on file operations and Master Password management.
- **[Encryption Technology](./encryption_detail)**: Deep dive into AES-256-GCM and memory security.
