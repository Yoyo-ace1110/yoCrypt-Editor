...
- **[Feature Guide](./features.md)**: Details on file operations and Master Password management.
- **[Encryption Technology](./encryption.md)**: Deep dive into AES-256-GCM and memory security.
