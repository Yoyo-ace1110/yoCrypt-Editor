...
- Disclaimer: This software is provided "as is", without warranty of any kind. The authors shall not be held liable for any damages or consequences resulting from its use.
...
**yoCrypt-Editor** 是一款旨在建立**輕量、快速、介面簡潔**，並整合**加密功能**的文字編輯器。它結合了 Python 的開發彈性與 C++ 的運算效能，為敏感資料提供保護。

## ✨ 主要特色

- **輕量與快速**: 優化的啟動速度與低資源佔用，讓文字處理流暢無負擔。
- **UI設計簡潔**: 基於 **PySide6** 與 **QDarkTheme**，提供現代化且專注的作業環境。
- **內建加密功能**: 整合 **OpenSSL 3** 核心技術，確保您的資料安全性達到工業級標準。
- **內建C++依賴**: 內建所有必要的 DLL，使用者無需額外安裝 OpenSSL 或 C++ 運行庫即可直接執行。
...
- 欲了解完整授權細節，請參閱 [LICENSE](https://github.com/Yoyo-ace1110/yoCrypt-Editor/blob/main/.github/LICENSE)。
